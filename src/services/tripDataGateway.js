...
const DESTINATION_HEADS_UPS = [
  ...
  {
    match: ["ortigia", "siracusa", "syracuse", "sicily", "sicilia", "catania", "rome", "florence", "venice", "milan", "naples", "italy"],
    coastal: true,
    water: "Tap water in Italy and Ortigia is safe to drink (potable). Public drinking fountains ('nasoni') are located around Piazza del Duomo.",
    alcohol: "Minimum legal age to purchase or consume alcohol in bars and restaurants is 18; venue staff may check ID.",
    drinkDriving: "Drink-driving limit: 0.5 g/L blood alcohol for standard drivers; 0.0 g/L for drivers under 21 and in their first 3 years of driving.",
    speed: "Typical Italy limits: 50 km/h urban, 90 km/h extra-urban, 130 km/h Autostrada. Note: Ortigia is a strict ZTL zone (Zona a Traffico Limitato) with camera enforcement.",
    commute: "Ortigia is compact and walkable. SAIS & AST buses link Siracusa to Catania Airport; Navetta ZTL electric shuttles loop around Ortigia.",
    commuteRating: "Walkable historic center",
    commuteProvider: "SAIS Autolinee & AST Siracusa",
    commuteProviderUrl: "https://www.saisautolinee.it",
    rules: "Strict ZTL rules apply in Ortigia; park at Parcheggio Molo Sant'Antonio or Talete. Tourist tax €1.50–€3.00/night.",
    sources: ["Azienda Sanitaria Provinciale Siracusa", "Ministero della Salute Italy", "European Commission road-safety guidance"],
  },
  {
    match: ["barcelona", "lisbon", "amsterdam"],
    coastal: true,
